...
public interface EventRepository extends JpaRepository<Evenement,Long>,
    ...
    @Query("""
        ...
        AND   e.statutEvenement != com.pfe.backend.entities.enums.StatutEvenement.BROUILLON
        ORDER BY
            CASE e.statutEvenement
                WHEN com.pfe.backend.entities.enums.StatutEvenement.EN_ATTENTE THEN 0
                WHEN com.pfe.backend.entities.enums.StatutEvenement.APPROUVE   THEN 1
                WHEN com.pfe.backend.entities.enums.StatutEvenement.REJETE     THEN 2
                ELSE 3
            END ASC,
        e.dateCreation DESC
""")
